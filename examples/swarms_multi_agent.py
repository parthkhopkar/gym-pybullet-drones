...
env = FlockAviary(gui=True, record=True, num_drones=len(initial_positions), act=ActionType.PID, initial_xyzs=np.array(initial_positions))
DT = 1/env.SIM_FREQ
...
for i in range(17*env.SIM_FREQ):
    env2d.update(DT)
